jQuery.fn.PageTransition = function ( params ) {
	...
	function transitionTo( evt ) {
		...
		transitioner.load(target + ' .page_wrap', function( response, status, xhr){afterLoad(target, response, status, xhr)});
		return false;
	}

	function afterLoad( target ) {
		let footer = jQuery( '<div class="offscreen-footer"><a href="/" class="js-transition">zurueck</a></div>');
