...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:c3baxi/Resources/Private/Language/locallang_db.xlf:tx_c3baxi_domain_model_haltestelle',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_c3baxi_domain_model_haltestelle}.{#pid}=###CURRENT_PID### AND {#tx_c3baxi_domain_model_haltestelle}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
		...
		'number' => [
			'exclude' => true,
			'label' => 'LLL:EXT:c3baxi/Resources/Private/Language/locallang_db.xlf:tx_c3baxi_domain_model_haltestelle.number',
			'config' => [
				'type' => 'input',
				'size' => '10',
				'eval' => 'trim'
        ...
        'latitude' => [
            'exclude' => true,
            'label' => 'LLL:EXT:c3baxi/Resources/Private/Language/locallang_db.xlf:tx_c3baxi_domain_model_haltestelle.latitude',
            'config' => [
                'type' => 'input',
                'size' => 30,
        ...
        'longitude' => [
            'exclude' => true,
            'label' => 'LLL:EXT:c3baxi/Resources/Private/Language/locallang_db.xlf:tx_c3baxi_domain_model_haltestelle.longitude',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'double2,required'
        ...
        'zone' => [
            'exclude' => true,
            'label' => 'LLL:EXT:c3baxi/Resources/Private/Language/locallang_db.xlf:tx_c3baxi_domain_model_haltestelle.zone',
            'config' => [
                'type' => 'inline',
